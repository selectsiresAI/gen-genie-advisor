                ...
                <table className="w-full border-collapse">
                  <thead className="sticky top-0 z-10 bg-muted">
                    <tr className="bg-muted">
                      <th className="border px-2 py-1 text-center text-xs font-semibold text-foreground bg-muted">✓</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">NAAB</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">Nome</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">Registro</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">Pedigre Pai/Avô Materno/BisaAvô Materno</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">Data de Nascimento</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">Empresa</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">HHP$®</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">TPI</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">NM$</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">CM$</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">FM$</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">GM$</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">F SAV</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">PTAM</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">CFP</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">PTAF</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">PTAF%</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">PTAP</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">PTAP%</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">PL</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">DPR</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">LIV</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">SCS</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">MAST</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">MET</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">RP</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">DA</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">KET</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">MF</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">PTAT</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">UDC</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">FLC</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">SCE</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">DCE</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">SSB</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">DSB</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">H LIV</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">CCR</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">HCR</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">FI</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">BWC</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">STA</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">STR</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">DFM</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">RUA</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">RLS</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">RTP</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">FTL</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">RW</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">RLR</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">FTA</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">FLS</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">FUA</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">RUH</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">RUW</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">UCL</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">UDP</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">FTP</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">RFI</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">Beta-Caseina</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">Kappa-Caseina</th>
                      <th className="border px-2 py-1 text-left text-xs font-semibold text-foreground bg-muted">GFI</th>
                    </tr>
                  </thead>
                  <tbody>
