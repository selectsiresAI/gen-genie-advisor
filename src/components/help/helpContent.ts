...
export const helpContentMap: Record<string, HelpContent> = {
  ...
  "auditoria-step5": {
    faq: [
      {
        question: "O que este step faz diferente da Step 4?",
      ...
      {
        question: "O que fazer quando o sistema não encontra categorias?",
        answer: "3 opções: 1) Preencha coluna 'Categoria' manualmente na aba Rebanho. 2) Certifique-se de ter coluna 'Paridade' (0, 1, 2, 3...). 3) Importe dados novamente com template atualizado. Sistema tenta buscar no localStorage mas pode falhar se dados mudaram muito."
      }
    ],
    resources: [
      {
  ...
  "auditoria-step6": {
    faq: [
      {
        question: "Qual a diferença entre Step 3 e Step 6?",
