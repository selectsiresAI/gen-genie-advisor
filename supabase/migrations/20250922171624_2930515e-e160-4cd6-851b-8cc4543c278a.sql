-- Correção de Security Definer Views - Versão Simplificada
-- Recriar apenas as views como views normais (sem SECURITY DEFINER)

-- 1. Remover as views existentes
...
-- 2. Recriar bulls_denorm como view normal
