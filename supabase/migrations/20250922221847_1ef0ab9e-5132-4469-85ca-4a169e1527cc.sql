-- Adicionar a coluna company na tabela bulls
ALTER TABLE public.bulls ADD COLUMN IF NOT EXISTS company TEXT;

-- Atualizar a view bulls_denorm para incluir a coluna company
